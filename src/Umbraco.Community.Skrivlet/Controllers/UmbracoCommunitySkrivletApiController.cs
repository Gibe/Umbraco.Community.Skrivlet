...
namespace Umbraco.Community.Skrivlet.Controllers
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "Umbraco.Community.Skrivlet")]
    public class UmbracoCommunitySkrivletApiController : UmbracoCommunitySkrivletApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public UmbracoCommunitySkrivletApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
