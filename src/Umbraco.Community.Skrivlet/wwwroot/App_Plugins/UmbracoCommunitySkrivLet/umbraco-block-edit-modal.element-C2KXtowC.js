import { html as p, repeat as g, nothing as T, css as $, state as y, customElement as M } from "@umbraco-cms/backoffice/external/lit";
...
}, f = (e, t, o) => t.has(e) || b("Cannot " + o), a = (e, t, o) => (f(e, t, "read from private field"), o ? o.call(e) : t.get(e)), h = (e, t, o) => t.has(e) ? b("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, o), D = (e, t, o, r) => (f(e, t, "write to private field"), t.set(e, o), o), _ = (e, t, o) => (f(e, t, "access private method"), o), n, m, d, k, w, v, C, E;
class W extends B {
  constructor(t, o) {
    super(t);
...
let l = class extends x {
  constructor() {
    super(...arguments), h(this, d), h(this, n, new P(this, new U(this))), h(this, m), this._isLoading = !0, this._loadError = !1, this._groups = [], h(this, v, () => {
      const e = a(this, m)?.getValuesRecord() ?? {}, t = a(this, n).getOwnerContentType()?.alias ?? "";
      this.value = { values: e, contentTypeAlias: t }, this._submitModal();
    });
  }
  firstUpdated() {
  ...
  render() {
    return p`
      <umb-body-layout headline=${this._contentTypeName ?? "Edit block"}>
        ${this._isLoading ? _(this, d, C).call(this) : _(this, d, E).call(this)}
        <div slot="actions">
...
k = async function() {
  ...
  D(this, m, new W(this, this.data?.values ?? {}));
...
//# sourceMappingURL=umbraco-block-edit-modal.element-C2KXtowC.js.map
