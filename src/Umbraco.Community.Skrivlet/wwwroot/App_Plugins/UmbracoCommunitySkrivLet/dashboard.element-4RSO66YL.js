import { LitElement as w, html as _, css as x, state as m, customElement as C } from "@umbraco-cms/backoffice/external/lit";
...
class d {
  static ping(e) {
    return (e?.client ?? c).get({
      ...
      url: "/umbraco/umbracocommunityskrivlet/api/v1/ping",
      ...e
    });
  }
  static whatsMyName(e) {
    return (e?.client ?? c).get({
      ...
      url: "/umbraco/umbracocommunityskrivlet/api/v1/whatsMyName",
      ...e
    });
  }
  static whatsTheTimeMrWolf(e) {
    return (e?.client ?? c).get({
      ...
      url: "/umbraco/umbracocommunityskrivlet/api/v1/whatsTheTimeMrWolf",
      ...e
    });
  }
  static whoAmI(e) {
    return (e?.client ?? c).get({
      ...
      url: "/umbraco/umbracocommunityskrivlet/api/v1/whoAmI",
      ...e
    });
  }
}
var M = Object.defineProperty, k = Object.getOwnPropertyDescriptor, b = (t) => {
  ...
  for (var o = a > 1 ? void 0 : a ? k(e, r) : e, h = t.length - 1, p; h >= 0; h--)
    (p = t[h]) && (o = (a ? p(e, r, o) : p(o)) || o);
  return a && o && M(e, r, o), o;
}, g = (t, e, r) => e.has(t) || b("Cannot " + r), s = (t, e, r) => (g(t, e, "read from private field"), r ? r.call(t) : e.get(t)), l = (t, e, r) => e.has(t) ? b("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), E = (t, e, r, a) => (g(t, e, "write to private field"), e.set(t, r), r), n, v, f, y;
let i = class extends T(w) {
  constructor() {
    super(), this._yourName = "Press the button!", l(this, n), l(this, v, async (t) => {
      const e = t.target;
      e.state = "waiting";
...
//# sourceMappingURL=dashboard.element-4RSO66YL.js.map
