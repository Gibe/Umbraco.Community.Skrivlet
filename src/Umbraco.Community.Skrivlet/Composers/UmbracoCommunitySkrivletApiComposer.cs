...
{
    public class UmbracoCommunitySkrivletApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Umbraco Community Skrivlet Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<UmbracoCommunitySkrivletOperationSecurityFilter>();
            });
        }

        public class UmbracoCommunitySkrivletOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Umbraco.Community.Skrivlet.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
